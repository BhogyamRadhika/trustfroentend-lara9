...
<a href="https://wa.me/+919014638633?text=Hello%20I%20want%20to%20book%20a%20home%20collection%20service... 🔬😊"
    ...
    <section class="content-section">
        <div class="content-container">
            <div class="text-column">
				...
				<h3 style="font-size: 1.65em;" class="caveat- whath3">Fosters an empathetic, happy & productive team  — that’s the TRUSTlab difference.</h3>

                <p class="section-paragraph">At TrustLab Diagnostics, we prioritize work-life balance as a fundamental aspect of our workplace culture. We understand that a healthy equilibrium between professional responsibilities and personal life is essential for our employees’ well-being and productivity. We also believe that when our employees feel balanced and supported, they are more engaged, motivated, and productive, contributing to our collective success.</p>
            </div>
            <div class="image-column">
                <img src="{{asset('lab/img/arcwork.svg')}}" alt="Our Culture" class="section-image">
            </div>
        </div>
    </section>
	...
	<section class="content-section reverse">
        <div class="content-container">
            <div class="image-column">
                <img src="{{asset('lab/img/career4.svg')}}" alt="Our People" class="section-image">
            </div>
            <div class="text-column">
                ...
                <p class="section-paragraph">Our diverse staff and their knowledge & commitment in achieving our mission and vision drives every single aspect of our organization. We select the very best well qualified individuals for every role that is assayed at TRUSTlab, to ensure that every service at every level across every department is performed with perfection & efficiency. The company is committed to respecting diversity in ethnic, gender, age & sexual orientation, personal characteristics & opinion seeking to recruit collaborators from local communities in order to incorporate their cultures into company practices, making TRUSTlab a Nation-wide business with a local presence and flavour. </p>
            </div>
        </div>
    </section>
    ...
    <section class="content-section">
        <div class="content-container">
            ...
            <div class="image-column">
                <img src="{{asset('lab/img/Cricket.svg')}}" alt="Employee Benefits" class="section-image">
            </div>
    ...
    <!-- <section class="content-section">
        <div class="content-container">
            <div class="text-column">
                <h2 class="carsection-title">Growth Opportunities</h2>
                <p class="section-paragraph">At TRUSTlab, we are committed to your professional growth. Whether it’s through mentorship programs, skills workshops, or career development courses, we equip you with the tools to succeed and advance your career.</p>
            </div>
            <div class="image-column">
                <img src="img/career3.svg" alt="Growth Opportunities" class="section-image">
            </div>
        </div>
    </section> -->
