...
<a href="https://wa.me/+919014638633?text=Hello%20I%20want%20to%20book%20a%20home%20collection%20service... 🔬😊"
        ...
        <div class="job-container">
            ...
            <div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-description">As a Business Development Executive you will be responsible for driving sales activities within assigned territory by managing sales team, performing sales forecasts, ensuring sales revenue and profit growth.</p>
            ...
            <div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">The Laboratory Supervisor is responsible for overseeing the operations of the laboratory on a day-to-day basis, per shift, to ensure highest test quality while meeting regulatory and compliance requirements.</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
            ...
            <div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As an Executive - Graphic Design, you are responsible for developing visual ideas and designs using digital tools or manual methods, that portray the company’s visual outlook on online and offline platforms...</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
            ...
            <div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As an Executive – Information Technology, you will work in a position using computer-based information systems. You will work with both network and software applications and computer hardware.</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
            ...
            <div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As an Executive - Logistics, you are responsible for ensuring that pathology samples are picked up and are delivered to the right lab location on time, and in the most cost-effective way. You will oversee the distribution...</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
            ...
            <div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As an Executive Assistant you will provide high-level executive support in a one-on-one working relationship. You will serve as the primary point of contact for internal and external stakeholders on all matters...</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
			...
			<div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As an Executive Purchases you are primarily responsible to manage the company’s supply of products and services. As an Executive Purchases your responsibilities include strategizing to find cost-effective deals...</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
			...
			<div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As an Executive-Stores you are essential for maintaining an efficient and organized inventory management system. With the constant flow of goods and products in and out, it is crucial to have someone who...</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
			...
			<div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As Manager Quality you are responsible for TRUSTlab Diagnostics labs, PAN INDIA. You will provide technical advice on evidence-based methods and strategies, current practices, and established laboratory standards ...</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
			...
			<div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As an Executive-Risk Management, you will add value by assisting TRUSTlab in implementing and improving compliance, governance and risk management-related processes and controls within TRUSTlab....</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
			...
			<div class="job-card">
                <div class="job-content">
                    ...
                    <p class="job-location">Hyderabad, India</p>
                    <p class="job-description">As an Executive-Digital Marketing, you will be generating new, creative content ideas to market company products and services . Creating high-quality content. Collaborating with other marketing teams...</p>
                    <button class="apply-button">Apply Now</button>
                </div>
            </div>
    ...
    <div class="career-section" style="background-image: url('{{asset('lab/img/loginbg.png')}}')">
