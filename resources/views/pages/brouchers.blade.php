...
@section('content')
<a href="https://wa.me/+919014638633?text=Hello%20I%20want%20to%20book%20a%20home%20collection%20service... 🔬😊" class="whatsapp-float" target="_blank">
		...
		<div class="breadcrumbs overlay breadcrumbsblog">
			<div class="container">
				<div class="bread-inner">
					<div class="row">
						<div class="col-12">
							<h2>TRUSTlab Brochures</h2>
							<ul class="bread-list">
								<li><a href="diagnosticsolutions.html">Home</a></li>
								<li><i class="icofont-simple-right"></i></li>
								<li class="active">TRUSTlab Brochures</li>
							</ul>
						</div>
					</div>
				</div>
    ...
    <div class="brochures-container">
		...
		<div class="onesection-header">
			<span class="onesection-title">Allergy</span>
			<div class="line"></div>
			<div class="onesee-more">See More</div>
		</div>
        <div class="brochures-grid">
          <div class="brochure-card">
            <img src="{{asset('lab/img/brouchers/allergy.png')}}" alt="Brochure 1">
            <h3 class="brochure-title">Allergy Brochure</h3>
            <!-- <p class="brochure-text">Short description about Brochure 1</p> -->
            <a href="{{asset('lab/img/brouchers/Allergy-brocher')}}.pdf" class="download-btn" download>Download PDF</a>
          </div>
		  
    
          <div class="brochure-card">
            <img src="{{asset('lab/img/brouchers/diabetes.png')}}" alt="Brochure 2">
            <h3 class="brochure-title">Diabetes Info</h3>
            <!-- <p class="brochure-text">Short description about Brochure 2</p> -->
            <a href="{{asset('lab/img/brouchers/Diabetes Brochure-8.pdf')}}" class="download-btn" download>Download PDF</a>
          </div>

		  <div class="onesection-header">
			<span class="onesection-title">Markers</span>
			<div class="line"></div>
			<div class="onesee-more">See More</div>
		</div>
    
          <div class="brochure-card">
            <img src="{{asset('lab/img/brouchers/ihc.png')}}" alt="Brochure 3">
            <h3 class="brochure-title">IHC Markers</h3>
            <!-- <p class="brochure-text">Short description about Brochure 3</p> -->
            <a href="{{asset('lab/img/brouchers/IHC.pdf')}}" class="download-btn" download>Download PDF</a>
          </div>

		  <div class="brochure-card">
            <img src="{{asset('lab/img/brouchers/karyotyping.png')}}" alt="Brochure 3">
            <h3 class="brochure-title">Karyotyping</h3>
            <!-- <p class="brochure-text">Short description about Brochure 3</p> -->
            <a href="{{asset('lab/img/brouchers/Karyotyping.pdf')}}" class="download-btn" download>Download PDF</a>
          </div>

		  <div class="brochure-card">
            <img src="{{asset('lab/img/brouchers/penta.png')}}" alt="Brochure 3">
            <h3 class="brochure-title">Penta Marker</h3>
            <!-- <p class="brochure-text">Short description about Brochure 3</p> -->
            <a href="{{asset('lab/img/brouchers/Penta-Marker.pdf')}}" class="download-btn" download>Download PDF</a>
          </div>

		  <div class="onesection-header">
			<span class="onesection-title">Transplants</span>
			<div class="line"></div>
			<div class="onesee-more">See More</div>
		</div>

		  <div class="brochure-card">
            <img src="{{asset('lab/img/brouchers/respiratory.png')}}" alt="Brochure 3">
            <h3 class="brochure-title">Respiratory Info</h3>
            <!-- <p class="brochure-text">Short description about Brochure 3</p> -->
            <a href="{{asset('lab/img/brouchers/Respiratory.pdf')}}" class="download-btn" download>Download PDF</a>
          </div>

		  <div class="brochure-card">
            <img src="{{asset('lab/img/brouchers/transplant.png')}}" alt="Brochure 3">
            <h3 class="brochure-title">Transplant Immunology</h3>
            <!-- <p class="brochure-text">Short description about Brochure 3</p> -->
            <a href="{{asset('lab/img/brouchers/Transplant-Immunology.pdf')}}" class="download-btn" download>Download PDF</a>
          </div>
