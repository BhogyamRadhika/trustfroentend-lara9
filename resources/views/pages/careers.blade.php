			...
			<div class="col-lg-12">
				<div class="section-title" style="padding-top: 50px; letter-spacing: 0.02em; line-height: 2%;">
					<h6 style="margin-bottom: 20px;">
                        At TRUSTlab, we are always on the lookout for talented individuals who share our passion for delivering exceptional healthcare services. <br/>Even if you don't see a current opening that matches your skills, we encourage you to submit your CV through the form below.</h6>

                        <h6 style="margin-bottom: 20px;">
                            Our team regularly reviews all submissions, and if a relevant opportunity arises, we'll be sure to get in touch. Join us and be a part of a workplace that values Empathy, Happiness & Productivity. We look forward to hearing from you!</h6>
