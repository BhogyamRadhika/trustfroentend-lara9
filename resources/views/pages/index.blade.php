  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="modal-image-container">
        <img src="{{asset('lab/img/lifestylepackage.png')}}" alt="Heart Package" class="modal-image">
      </div>
    </div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-12 thehomecontent">
					<div class="content div1 milestone">
						<p style="font-size: 1.2rem; font-weight: bold;">Your health is too important for a waiting room.</p>
						<h2>Think Home Collection <br>Think <span style="font-size: 50px; margin-top: -50px;">TRUSTlab!</span><br>Call
							@ 74400 75400</h2>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                            ...
                            <p>Our dedicated team is available around the clock to provide you with all the information and support you need.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
