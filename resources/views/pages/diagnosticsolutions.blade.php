...
<a href="https://wa.me/+919014638633?text=Hello%20I%20want%20to%20book%20a%20home%20collection%20service... 🔬😊"
		...
		<div class="myfixedbanner">
			<img class="banner-image landscape" src="{{asset('lab/img/wishesbanner.svg')}}" alt="img" />
			<img src="{{asset('lab/img/wishpotrait.svg')}}" alt="Banner" class="banner-image portrait">
		</div>

		<!-- <section class="slider">
			<div class="hero-slider">

				<div class="single-slider" style="background-image:url('img/wishes.svg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>A healthy person has a thousand wishes, <span>a sick person has only one</span></h1>

									<h1 style="margin-top: 30px;"><span style="font-style: italic; color: #1F2B7B;">- To get well <span style="color: #1F2B7B; font-weight: bolder;" >soon</span></span></h1>
		...
		<section class="why-choose section" style="margin-top: -7%;">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
				...
				<div class="video-container milestone">
					<video id="myVideo" class="video" controls controlsList="nodownload" poster="{{asset('lab/img/bgintro.png')}}">
						<source src="{{asset('lab/img/TRUSTlabintro.mp4')}}" type="video/mp4">
		...
		<!-- <div style="text-align: center;" class="image-container">
            <img src="{{asset('lab/img/y-put-trust.png')}}" style="padding: 50px;" />
		...
		<div id="fun-facts" class="fun-facts section overlay background-video">
			<video autoplay loop muted>
				<source src="{{asset('lab/img/fun2.mp4')}}" type="video/mp4">
			...
			<div class="container">
				<div class="row milestone">
					<div class="col-lg-12 col-md-12 col-12">
						<h2
							style="color: #fff; margin-bottom: 70px; text-align: center; font-weight: bold; font-style: italic; letter-spacing: 0.1rem;">
							Accelerating patient care begins in the laboratory.</h
		...
		<div class="container" style="padding-top: 7%; text-align: center; padding-bottom: 7%; font-weight: bold;">
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title milestone">
						<h2 style="line-height: 120%; text-align: center; font-weight: bolder;">Our Quality Commitment
						</h2>
						<!-- <img src="img/section-img.png" alt="#"> -->
						<!-- <p>Empowering medical professionals with invaluable insights to enhance patient care and
							drive better health outcomes.</p> -->
			...
			<img src="{{asset('lab/img/QC.png')}}" style="margin-top: -20px;" width="90%" class="milestone"
				alt="Quality Reports brings TRUST">
			<h3 class="qah3">"Our pursuit to attain the highest standards of quality in medical diagnostics is a given,
				but it is the attention to detail and care that we invest to achieve this quality of work that sets us
				apart from the rest and makes us the preferred choice of Medical Diagnostics Partner".</h3>
		</div>
						...
						<div class="single-news">
							...
							<div class="news-body">
								<div class="news-content">
									...
									<p class="text">In this article, we'll delve into the essential health screenings
										every
							...
							<div class="news-body">
								<div class="news-content">
									...
									<h2><a href="https://economictimes.indiatimes.com/jobs/fresher/eyeing-a-healthcare-career-here-are-the-trending-roles-skills-and-pay-brackets-you-should-know/articleshow/111190548.cms"
											target="_blank">Eyeing a healthcare career? Here are the trending roles</a>
									</h2>
									<p class="text">The Indian healthcare has seen a lot of growth in past few years and
										is
							...
							<div class="news-body">
								<div class="news-content">
									...
									<h2><a href="https://www.news18.com/lifestyle/health-and-fitness-important-tests-to-undertake-to-detect-dangerous-diseases-like-aids-8865572.html"
											target="_blank">Important Tests to Undertake to Detect Diseases like
											AIDS</a>
									</h2>
									<p class="text">Early detection of AIDS (Acquired Immunodeficiency Syndrome) is
										crucial
